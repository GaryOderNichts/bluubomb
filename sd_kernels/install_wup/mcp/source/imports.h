...
#define IOS_CreateThread        ((int(*)(int (*proc)(void* arg), void* arg, void* stack_top, uint32_t stacksize, int priority, uint32_t flags)) 0x050567ec)
#define IOS_StartThread         ((int(*)(int threadid)) 0x05056824)
#define IOS_GetThreadPriority	((int(*)(int threadid)) 0x0505683c)
...
#define _strncpy				((int(*)(char*, const char*, uint32_t)) 0x05055db4)
