...
#define IOS_Open                    ((int (*)(const char* device, int mode)) 0x0812940c)
#define IOS_Close                   ((int (*)(int fd)) 0x08129368)
#define IOS_Ioctl                   ((int (*)(int fd, uint32_t request, void *input_buffer, uint32_t input_buffer_len, void *output_buffer, uint32_t output_buffer_len)) 0x081290e0)
